    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Заявка на регистрацию</div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label">Эл. адрес</label>
                        ...
                        <div class="form-group{{ $errors->has('secret_word') ? ' has-error' : '' }}">
                            <label for="secret_word" class="col-md-4 control-label">Секректное слово</label>

                            <div class="col-md-6">
                                <input id="secret_word" type="password" class="form-control" name="secret_word" required>

                                @if ($errors->has('secret_word'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('secret_word') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
